...
return [
    ...
    /*
     * The maximum file size of an item in bytes. Raised from the package
     * default of 10MB to match this app's upload limit (php.ini's
     * upload_max_filesize / nginx's client_max_body_size, both 200MB) —
     * DMS document uploads (Word/Excel/PowerPoint, scanned PDFs) routinely
     * exceed 10MB.
     */
    'max_file_size' => (int) env('MEDIA_MAX_FILE_SIZE', 1024 * 1024 * 200), // 200MB
