...
class Accountant{
    ...
    protected $_bank_income_statement= 'Accountant/BankIncomeStatement';
    protected $_card_income_statement= 'Accountant/CardIncomeStatement';
            ...
            'navigations' => [
                'Accounts|AC' => [
                    ...
                    [
                        ...
                        'perm' => 'all',
                        'user_config' => 'is_accountant',
                        'module' => 'Bank Income Statement',
                        'icon' => 'fas fas fa-history',
                        'path' => $this->_bank_income_statement,
                        'order' => 101
                    ],
                    [
                        'label' => 'Card Income Statement',
                        'perm' => 'all',
                        'user_config' => 'is_accountant',
                        'module' => 'Card Income Statement',
                        'icon' => 'fas fas fa-history',
                        'path' => $this->_card_income_statement,
                        'order' => 101
                    ],
                    [
