                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="font-red-sunglo">
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-chess-queen fa-2x m-r-2"></i> <?= $business_name ?> - Expense STATEMENT </h3>
                                            ...
                                            <table id="example" class="table table-bordered table-responsive table-stipped" cellspacing="0" width="100%">
                                                ...
                                                <?php
                                                    $counter = 0;
                                                        ...
                                                        if($counter == 0){ ?>
                                                            <tr>
                                                                <td colspan="4">No Expense Transaction during this time.</td>
                                                            </tr>
                                                        <?php 
                                                        }
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="3" class="text-right"><strong>Expense Total</strong></td>
                                                        <td><?= $exp_ammount ?></td>
                                                        <td><?= $total_amount ?></td>
                                                    </tr>
                                                    <tr class="bg-warning lighter">
                                                        <td colspan="5"><strong>Expense Statement Summery</strong></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="text-right"><strong>Expense</strong></td>
                                                        <td><?= $exp_ammount ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
