                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
							<div class="caption font-red-sunglo">
								...
								<span class="caption-subject bold uppercase">Pay Expence</span>
							</div>
						</div>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-md-line-input has-success">
                                                <div class="input-icon">
                                                    <input type="text" required class="form-control" name="payment_reference">
                                    ...
                                    <div class="form-actions noborder text-right">
                                        <button type="submit" class="btn blue"><i class="fab fa-amazon-pay fa-3x"></i>Pay</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        jQuery(document).ready(function() {
            ...
            $('#payed_to').on('change',function () {
                if($(this).val() == 'others'){
                    ...
                    $('#payed_to_doctor_container').show();
                    $('#inpt_id_selection').show()
                }
            })
