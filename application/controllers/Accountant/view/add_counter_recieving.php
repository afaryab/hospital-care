                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Add Counter Recieving</span>
                        </div>
                        
                    </div>
                    <div class="caption font-red-sunglo" style="text-align:center; font-size: 18px;">
                            ...
                            <div class="row" id="payment_box_container">
                                <div class="col-md-12 m-t-4 m-b-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input type="number" class="form-control" name="cash_recieved_amount" value="<?= $closing_cash ?>" required >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" name="cash_recieved_by" required >
