                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Inpatient Payment Counter</span>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                ...
                                                <label for="form_control_1"> Amount To Receive</label>
                                                <span class="help-block"> Amount To Receive From Patient.</span>
