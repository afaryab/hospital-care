...
class RecestationCounter extends MY_Controller
{
    ...
    public function index(){
        ...
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Hospital Recestation Counter';
            $this->_pageData['module'] = 'Hospital Recestation Counter';
            ...
            if($this->havePost() && array_key_exists('cart_services',$_POST)){
                ...
                if(array_key_exists('patient_id', $_POST) && $_POST['patient_id'] != 0){
                    ...
                    $this->commonModel->setTableName('recestation_patients');
                    $recestationPatient =  $this->commonModel->findOneBy(['site_patient_id' => $_POST['patient_id']]);
                    ...
                    $recestationPatientId = $this->recestation_patients->addNew([
                        'site_patient_id' => $patientId
                    ]);
                    $recestationPatient =  $this->recestation_patients->findOneBy(['id' => $recestationPatientId]);
                ...
                foreach($_POST['cart_services'] as $cartService){
                    ...
                    if($cartService['servicetype'] == 'OPD'){
                    ...
                    }elseif($cartService['servicetype'] == 'RECES'){
                        ...
                        $treatmentId = $this->recestation_treatments->addNew($treatmentArray);
                        ...
                        $transactionId = $this->recestation_transactions->addNew($arrayToDB);
            ...
            $html = $this->load->makeViewWithOutTemplate('counter/counter_recestation', $this->_pageData, true);
            $this->makeView($html);
        }else{
