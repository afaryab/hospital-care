                    ...
                    <div class="invoice">
                        <div class="row">
                            ...
                            <h1 class="uppercase"><?= business_contact_name ?><small style="font-size: 15px;"> <?= location_name?> </small></h1>
                                ...
                                <h5>Income Report By User (<?= $reporteeUser->name ?>) & Date (<?= $dateRange ?>).</h5>
                                <hr/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <table class="table table-bordered">
                                    ...
                                    ?>
                                    <tr class="gray">
                                        <td colspan="6"><strong>CASH Report</strong></td>
                                    </tr>
                                    <?php
                                    $total_amount = 0;
                                    $ctotal = 0;
                                        ...
                                        foreach ($transactions as $row) {
                                            if($row['transaction']['payment_type'] == 'CASH'){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>REF: <?= $row['transaction']['payment_refference'] ?> | SER: <?php
                                                        if($row['transaction']['service_id'] == 1){
                                                            echo 'X-Ray';
                                                        }elseif($row['transaction']['service_id'] == 2){
                                                            echo 'Implant';
                                                        }elseif($row['transaction']['service_id'] == 3){
                                                            echo 'Consultation';
                                                        }elseif($row['transaction']['service_id'] == 4){
                                                            echo 'Others';
                                                        }elseif($row['transaction']['service_id'] == 5){
                                    ...
                                    ?>
                                    <tr class="gray">
                                        <td colspan="6"><strong>CARD REPORT</strong></td>
                                    </tr>
                                    <?php
                                    $ctotal = 0;
                                    if(!empty($transactions)){
                                    ...
                                    ?>
                                    <tr class="gray">
                                        <td colspan="6"><strong>CHECK Report</strong></td>
                                    </tr>
                                    <?php
                                    $ctotal = 0;
                                    if(!empty($transactions)){
