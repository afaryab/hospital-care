...
class Migration_create_emergency_transactions extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("emergency_transactions", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("emergency_transactions", TRUE);
    }
