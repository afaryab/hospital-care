...
class Migration_create_inpatient_expense_transactions extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("inpatient_expense_transactions", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("inpatient_expense_transactions", TRUE);
    }
