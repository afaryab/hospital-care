export default function CreatePatientPolicy({
    className,
}: {
    className?: string;
}) {
                ...
                <div className="flex items-start gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-red-900">
                            ...
                            institutional governance standards and may amount to
                            non-compliance under the Punjab Healthcare
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-red-900">
                            <li className="flex gap-2">
                                ...
                                <span>
                                    Compromise patient safety and continuity of
                                    care
                                </span>
                            </li>
                            <li className="flex gap-2">
                                <span className="mt-1 h-2 w-2 rounded-full bg-red-700"></span>
                                <span>
                                    Invalidate medico-legal documentation
                                </span>
                            </li>
                            <li className="flex gap-2">
                                <span className="mt-1 h-2 w-2 rounded-full bg-red-700"></span>
                                <span>
                                    Expose the healthcare establishment to
                            ...
                            <li className="flex gap-2">
                                <span className="mt-1 h-2 w-2 rounded-full bg-red-700"></span>
                                <span>
                                    Result in inspection objections, fines,
                                    suspension, or sealing of services
                                </span>
                            </li>
                        </ul>
                        ...
                        <div className="mt-4 rounded-lg border border-red-200 bg-white p-3">
                            <p className="text-xs font-semibold text-red-800">
                                ...
                                action, regulatory reporting, and institutional
                                liability.
                            </p>
                        </div>
                ...
                <div className="mt-6 grid gap-4">
                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-slate-800">
                            ...
                            <li className="flex gap-2">
                                ...
                                <span>
                                    ...
                                    (Required) — for follow-up, results
                                    communication, continuity of care, complaint
                                    resolution, and patient traceability.
                                </span>
                            </li>
                            <li className="flex gap-2">
                                <span className="mt-1 h-2 w-2 rounded-full bg-slate-900"></span>
                                <span>
                                    ...
                                    (Required) — or Date of Birth where
                                    available; required for safe clinical
                                    decisions and lawful consent handling.
                                </span>
                            </li>
                            <li className="flex gap-2">
                                <span className="mt-1 h-2 w-2 rounded-full bg-slate-900"></span>
                                <span>
                                    ...
                                    (Required) — required for accurate clinical
                                    assessment, documentation integrity, and
                                    reporting.
                                </span>
                            </li>
                        </ul>
                        ...
                        <div className="mt-4 rounded-lg border border-slate-200 bg-white p-3">
                            <p className="text-xs text-slate-600">
                                ...
                                mandatory fields above are provided.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="rounded-xl border border-slate-200 p-4">
                        ...
                        <p className="mt-2 text-sm text-slate-700">
                            ...
                            initial OPD registration, but should be collected
                            where applicable (e.g., admissions, procedures,
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-slate-800">
                            <li className="flex gap-2">
                                ...
                                <span>
                                    ...
                                    (Optional at OPD; recommended/required by
                                    workflow where legally or clinically
                                    necessary)
                                </span>
                            </li>
                        </ul>
                    ...
                    <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
                        ...
                        <p className="mt-2 text-sm text-amber-900/90">
                            ...
                            healthcare establishments to maintain complete,
                            accurate, and retrievable patient records that
                            support identification, continuity of care, and
                            accountability during inspections and complaint
                            handling.
                        </p>
                    </div>
