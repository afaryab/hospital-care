...
import { apiLabSaveTreatment, apiLabUpdateStatus, labDashboard, labPatient } from '@/routes';
...
export default function LabPatient() {
    ...
    const breadcrumbs = [
        ...
        { title: serviceOrder.patient?.name ?? 'Patient', href: labPatient({ id: serviceOrder.id }).url },
    ];
    return (
