                                    ...
                                    {prescriptions.map((row, idx) => (
                                        <tr key={idx} className="bg-white hover:bg-slate-50">
                                            <td className="px-2 py-1.5">
                                                <input disabled={isFinalized} value={row.drug_name} onChange={(e) => updatePrescription(idx, 'drug_name', e.target.value)}
                                                    placeholder="Drug name" className={tableInputClass(isFinalized)} />
                                            </td>
                                            <td className="px-2 py-1.5">
