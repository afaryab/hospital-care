...
export default function DateTime({
	...
	const title = useMemo(() => (parsed ? (tooltipFormatter ? tooltipFormatter(parsed) : formatExact(parsed, locale)) : ""), [parsed, tooltipFormatter, locale]);

	if (!parsed || !rel) {
		return <span className={className} title="Invalid date">-</span>;
	}
