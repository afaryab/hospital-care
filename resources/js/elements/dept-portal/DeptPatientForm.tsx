...
export default function DeptPatientForm({
    ...
    const input =
        'w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-300 focus:outline-none';
            ...
            <div className="flex items-start justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <div>
                    ...
                    <div className="mt-1 text-xs text-slate-400">
                        {serviceOrder.so_number} · {serviceOrder.service?.name}
                    </div>
                </div>
                <div className="flex gap-2">
                    {!isFinalized &&
                        strtolower(serviceOrder.status) === 'open' && (
                            <button
                                onClick={callPatient}
                    ...
                    <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                            <div>
                                ...
                                <Icd10Picker
                                    value={diagnosisCode}
                                    disabled={isFinalized}
                                    className={isFinalized ? disabled : input}
                                    onSelect={(code, desc) => {
                                        setDiagnosisCode(code);
                                        setDiagnosisText(desc);
                                    }}
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Treatment plan, imaging findings, lab results…"
                            />
                        </div>
                    </div>
