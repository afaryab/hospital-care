...
<div class="page-content-wrapper">
    <div class="page-content">
		...
		$headerExpences = [];
            ...
            if(!array_key_exists('template', $_GET) || $_GET['template'] == 1){
                ?>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="font-red-sunglo">
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-chess fa-2x m-r-2"></i> <?= $business_name ?> - CASH FLOW STATEMENT </h3>
                            ...
                            <div class="portlet-body form">
                                <div class="content">
                                    <div class="row m-b-2">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="dashboard-stat blue-madison">
                                                ...
                                                <div class="details">
                                                    <div class="number" id="total_collection"><?= $inc_ammount ?>
                                                    </div>
                                                    <div class="desc">
                                                        Income
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="dashboard-stat blue-madison">
                                                ...
                                                <div class="details">
                                                    <div class="number" id="total_collection"><?= $exp_ammount ?>
                                                    </div>
                                                    <div class="desc">
                                                        Expense
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="dashboard-stat blue-madison">
                                                ...
                                                <div class="details">
                                                    <div class="number" id="total_collection"><?= $total_cash ?>
                                                    </div>
                                                    <div class="desc">
                                                        Ending Balance
                                                    </div>
                                    ...
                                    <div><button onclick="navFun()"><i class="fas fa-angle-down"></i></button></div>
                                            ...
                                            <table id="example" class="table table-bordered table-responsive table-striped" cellspacing="0" width="100%">
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td colspan="1"><button onclick="navFun()"><i class="fas fa-angle-down"></i></button></td> -->
                                                    </tr>
                                                    <?php
                                                    $counter = 0;
                                                    ...
                                                    if($counter == 0){ ?>
                                                        <tr class="bg-danger">
                                                            <td colspan="7">No Income Transaction during this time.</td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                                    <tr>
                                                        <td colspan="5" class="text-right"><strong>Income</strong></td>
                                                        <td><?= $inc_ammount ?></td>
                                                        <td><?= $total_amount ?></td>
                                                    </tr>
                                                </div>
                                                           ...
                                                           <tr>
                                                        <td colspan="7"><strong>Expense</strong></td>
                                                    </tr>
                                                    <?php
                                                    $counter = 0;
                                                        if(!empty($report_transactions)) {
                                                        ...
                                                        if($counter == 0){ ?>
                                                            <tr>
                                                                <td colspan="7">No Expense Transaction during this time.</td>
                                                            </tr>
                                                        <?php 
                                                        }
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="5" class="text-right"><strong>Expense Total</strong></td>
                                                        <td><?= $exp_ammount ?></td>
                                                        <td><?= $total_amount ?></td>
                                                    </tr>
                                                    <tr class="bg-warning lighter">
                                                        <td colspan="7"><strong>Statement Summery</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" class="text-right"><strong>Duration</strong></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="5" class="text-right"><strong>Expense</strong></td>
                                                        <td colspan="2"><?= $exp_ammount ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" class="text-right"><strong>Balance</strong></td>
                                                        <td colspan="2"><?= $inc_ammount - $exp_ammount ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div id="nav" class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <table id="example" class="table table-bordered table-responsive table-striped" cellspacing="0" width="100%">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th colspan="2">Department Vise income</th>
                                                ...
                                                <tbody >
                                                    ...
                                                    <?php
                                                    $totalDepartmentTransactionsSyum = 0;
                                                    if(!empty($departmentIncome)) {
                                                        foreach ($departmentIncome as $key=> $row) {
                                                            $totalDepartmentTransactionsSyum += $row;
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $key ?> </td>
                                                                <td><?php echo $row ?> </td>
                                                        ...
                                                        <tr class="bg-danger">
                                                            <td colspan="2">No Income Transaction during this time.</td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                                    <tr>
                                                        <td class="text-right"><strong>Income</strong></td>
                                                        <td><?= $totalDepartmentTransactionsSyum ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <table id="example" class="table table-bordered table-responsive table-striped" cellspacing="0" width="100%">
                                                ...
                                                <tbody >
                                                           ...
                                                           <tr>
                                                        <td colspan="6"><strong>Expense</strong></td>
                                                    </tr>
                                                    <?php
                                                    $counter = 0;
                                                        if(!empty($report_transactions)) {
                                                        ...
                                                        if($counter == 0){ ?>
                                                            <tr>
                                                                <td colspan="6">No Expense Transaction during this time.</td>
                                                            </tr>
                                                        <?php 
                                                        }
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="text-right"><strong>Expense Total</strong></td>
                                                        <td><?= $exp_ammount ?></td>
                                                    </tr>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <table id="example" class="table table-bordered table-responsive table-striped" cellspacing="0" width="100%">
                                                ...
                                                <tbody >
                                                    ...
                                                    <?php
                                                    $totalDepartmentTransactionsSyum = 0;
                                                    if(!empty($headerIncomes)) {
                                                        foreach ($headerIncomes as $key=> $row) {
                                                            $totalDepartmentTransactionsSyum += $row;
                                                            ?>
                                                            <tr>
                                                                <td><?php echo $key ?> </td>
