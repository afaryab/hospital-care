                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase"> Edit Expense </span>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-md-line-input has-success">
                                                <div class="input-icon">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Expense Name" name="name" value="<?= $expenses['name'] ?>" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="md-checkbox">
                                                ...
                                                <?php if($expenses['add_comments'] == '1'){ ?>
                                                                	checked="checked"
                                                                <?php } ?>>
                                        ...
                                        <div class="col-md-6">
                                            <h4> Block This Expense Category ? </h4>
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="checkdelete" value="1" name="is_deleted" class="md-check"
                                                <?php if($expenses['is_deleted'] == '1'){ ?>
                                                                	checked="checked"
                                                                <?php } ?>>
                                                <label for="checkdelete">
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                                                    <span class="box"></span></i>&nbsp;&nbsp;&nbsp;&nbsp; Block Category </label>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-6">
                                            <div class="form-group form-md-line-input has-success">
