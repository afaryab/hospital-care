...
class InpatientExpensePayment extends MY_Controller
{
    ...
    public function index(){
        ...
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Inpatient Expense';
            $this->_pageData['module'] = 'Inpatient Expense';
            ...
            $html = $this->load->makeViewWithOutTemplate('inpatient_expense_counter', $this->_pageData, true);
            $this->makeView($html);
