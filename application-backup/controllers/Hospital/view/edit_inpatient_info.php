                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                ...
                                                <?php $blance = $files['file_charges'];
                                                    ...
                                                    foreach($trans as $tran){ 
                                                        if ($files['id'] == $tran['file_id']){
                                                            $sum += $tran['amount_in_num']; 
                                                        }
                                                    }?>
                                                    <input type="text" class="form-control" placeholder="Recieved Amount" name="recieved_amount" value="<?= $sum ?>" disabled>
                                                    <label for="form_control_1">File Amount Recieved </label>
