                    ...
                    <div class="invoice">
                        <div class="row">
                            ...
                            <h1 class="uppercase"><?= business_contact_name ?><small style="font-size: 15px;"> <?= location_name?> </small></h1>
                                ...
                                <h5>Diagnosis Name (<?= $diagnosisName ?>).</h5>
                                <hr/>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    $ctotal = 0;
                                        if(!empty($treatments)){
                                            foreach ($treatments as $row) {
                                                ...
                                                <tr>
                                                    <td><?= $row['patient']['patient_age'] ?></td>
                                                    <td><?= $row['patient']['pateint_name'].' (ID: '.$row['patient']['id'].')' ?></td>
                                                    <td><?= $row['patient']['patient_contact_mobile'] ?></td>
                                                    <td><?php $user = $this->aauth->get_user($row['treatment']['treatment_by']); echo $user->name; ?></td>
                                                    <td><?= $row['treatment']['treatment_charges'] ?> PKR</td>
                                                </tr>
                                                <?php
                                            }
                                        }
