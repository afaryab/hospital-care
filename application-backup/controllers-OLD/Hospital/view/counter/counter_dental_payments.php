                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Dental Payments Counter</span>
                        </div>
                    </div>
                            ...
                            <div class="row" id="payment_box_container">
                                <div class="col-md-12 m-t-4 m-b-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input type="number" class="form-control" name="customer_payed_amount" required id="customer_payed_amount" onchange="calculateBillSpecial()" require="require">
...
<script type="application/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "pageLength": 3,
            "ajax": "<?= site_url($HOSPITAL_REC_PATH_DENTAL_FILE_SEARCH) ?>",
