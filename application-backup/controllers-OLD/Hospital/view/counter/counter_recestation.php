    ...
    function reRenderCart(){
        ...
        $.each(PosServices, function(index,value){
            ...
            if(value.id.startsWith("OPD")){
                ...
                recestation_html += ("<tr><td>"+makeServiceIdFeild(value.id, index)+"</td><td>"+value.name+"</td>"+makeQtyFeild(value.quantity, index, value.is_quantityable)+"<td>"+makeServiceProviderSelection("RECES", index ,value.is_doctor_selectable)+"</td>"+makeAmountFeild(value.charges, index,"RECES", value.fix_amount)+"<td>"+currentBalance+"</td><td>"+currentTax+"</td></tr>");
