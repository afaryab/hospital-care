                                    ...
                                    <div id="treatments-table-div" class="portlet-body form">
                                        <table id="example" class="table table-bordered table-strapped display" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;width:30%;"><strong>To</strong></td>
                                                <td style="text-align: center;width:30%;"><strong>Date</strong></td>
                                                <!-- <th>Balance</th> -->
                                            </tr>
                                                            ...
                                                            <table id="example" style="margin-bottom: 0px;margin-top: 0px;padding: 0px;line-height:0;" class="table table-bordered table-strapped display" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php if($rtrans['service_id'] == $ser['id']){
                                                                        $count = 1;
                                                                    ?>
                                                                        <td style="text-align: center;width:16%;"><?= $rtrans['amount_in_num'] ?><td style="text-align: center;width:42%;"><?= $this->aauth->get_user($rtrans['doctor_id'])->name ?></td><td style="text-align: center;width:42%;"><?= $rtrans['created_on'] ?></td><br>
                                                                    <?php }
                                                                    ?>
                                                                    </tr>
                                                                </tbody>
