...
class DentalPaymentsCounter extends MY_Controller
{
    ...
    public function index(){
        ...
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Hospital Dental Payments Counter';
            $this->_pageData['module'] = 'Hospital Dental Payments Counter';
            ...
            $html = $this->load->makeViewWithOutTemplate('counter/counter_dental_payments', $this->_pageData, true);
            $this->makeView($html);
