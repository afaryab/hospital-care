...
class InptExpenseCounter extends MY_Controller
{
    ...
    public function index(){
        ...
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Hospital Inpatient Expense Counter';
            $this->_pageData['module'] = 'Hospital Inpatient Expense Counter';
            ...
            if($this->havePost()){
                ...
                if($file['status'] == "OPEN"){
                    ...
                    $transactionId = $this->inpatient_expense_transactions->addNew($arrayToDB);
                    ...
                    redirect('Hospital/Reception/PrintReciept/Index/'.$receptionTransactionId);

                }else{
                    $this->setMessage('error', 'Inpatient Case is closed');
                }
            }
            
            
            $html = $this->load->makeViewWithOutTemplate('expense/inpatient_expense_counter', $this->_pageData, true);
            $this->makeView($html);
