...
class AddNewVoucher extends MY_Controller
{
...
//&& $this->aauth->is_allowed('Add New Expense Voucher','Accounts')
        if($this->isLoggedIn() ) {
            ...
            $this->_pageData['title'] = 'Make Expense Voucher';
            $this->_pageData['module'] = 'ExpenseVouchers';
            $this->_pageData['users'] = $this->aauth->list_users();
            $html = $this->load->makeViewWithOutTemplate('new_voucher', $this->_pageData, true);
            $this->makeView($html);
        }else{
