                ...
                <div class="portlet light bordered">
                    ...
                    <div id="treatments-table-div" class="portlet-body form">
                        <form method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <input type="text" class="form-control" placeholder="Treatment Name" required name="treatment_name">
                                        <label for="treatment_name">Treatment Name</label>
                                        <span class="help-block">Enter Treatment Name here.</span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input has-success">
                                    <label for="treatment_desc">Treatment Details</label>
                                    <span class="help-block">Enter Treatment Details here.</span>
                                    <div class="input-icon">
                                        <textarea class="form-control" placeholder="Treatment Description" name="treatment_desc"></textarea>
                                        <i class="fa fa-bell-o"></i>
                                    </div>
                                </div>
                            </div>
