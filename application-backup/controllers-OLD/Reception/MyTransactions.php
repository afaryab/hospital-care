...
class MyTransactions extends MY_Controller
{
    ...
    public function index(){
        ...
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'My Transactions';
            $this->_pageData['module'] = 'My Transactions';
...
//print_array($expVoucher);
            ...
            $html = $this->load->makeViewWithOutTemplate('list_my_transactions', $this->_pageData, true);
            $this->makeView($html);
