...
<div class="content">
	...
	<form class="login-form"  method="post">
		<div class="col-xs-8 col-xs-offset-2 text-center">
			...
			<h3 class="text-center" style="line-height:36px">Open Counter To Continue<h3>
		</div>
		<div class="col-sm-12 alert alert-danger display-hide">
				<button class="close" data-close="alert"></button>
                <span>
                  	Please Open Counter To Continue
                </span>
			</div>
		...
		<div class="form-group">
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Counter Name" name="counter_name" value="<?= $reception['counter_name'] ?>"/>
		</div>
		<div class="form-group form-md-line-input has-error">
			<input class="form-control form-control-solid placeholder-no-fix has-error" type="number" autocomplete="off" placeholder="Opening Cash" name="opening_cash"/>
		</div>
		<div class="form-group text-right">
			
			<button type="submit" class="btn btn-success uppercase" style="border-radius: 0px !important;">Continue</button>
