...
class Migration_create_ultrasound_treatments extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("ultrasound_treatments", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("ultrasound_treatments", TRUE);
    }
