...
class Migration_create_dental_treatments extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("dental_treatments", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("dental_treatments", TRUE);
    }
