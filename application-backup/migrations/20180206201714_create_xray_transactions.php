...
class Migration_create_xray_transactions extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("xray_transactions", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("xray_transactions", TRUE);
    }
