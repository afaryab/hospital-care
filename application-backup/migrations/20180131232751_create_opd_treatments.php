...
class Migration_create_opd_treatments extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("opd_treatments", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("opd_treatments", TRUE);
    }
