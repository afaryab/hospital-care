                            ...
                            <li style="width:100%;" class="m-t-2 m-b-2 container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-left m-t-4">
                                        ...
                                        <p><stong class="text-warning">Current Card: </stong><?= $counter['closing_amount_card'] ?></p>
...
//         initiate layout and plugins
    ...
    var myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
            labels: ['Cash (<?= $counter['closing_amount_cash'] ?> /- PKR)', 'Cheque (<?= $counter['closing_amount_atm'] ?> /- PKR)', 'Card (<?= $counter['closing_amount_card'] ?> /- PKR)'],
            datasets: [{
                label: '# of Votes',
                data: [ <?= $counter['closing_amount_cash'] ?>, <?= $counter['closing_amount_atm'] ?>, <?= $counter['closing_amount_card'] ?>],
                backgroundColor: [
                    'rgba(187,33,36, 1)',
                    'rgba(34,187,51, 1)',
                    'rgba(240,173,78, 1)'
