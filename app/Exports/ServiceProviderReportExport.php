...
class ServiceProviderReportExport implements FromQuery, Responsable, ShouldAutoSize, WithHeadings, WithMapping, WithTitle
{
    use Exportable;

    public string $fileName = 'service-provider-report.xlsx';
    ...
    {
        return ['Date', 'SO Number', 'Patient', 'Service', 'Department', 'Status', 'Income Collected', 'Expenses Paid to Provider'];
    }
    ...
    {
        return 'Service Provider Report';
    }
}
