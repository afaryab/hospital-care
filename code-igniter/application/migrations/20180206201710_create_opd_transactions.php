...
class Migration_create_opd_transactions extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("opd_transactions", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("opd_transactions", TRUE);
    }
