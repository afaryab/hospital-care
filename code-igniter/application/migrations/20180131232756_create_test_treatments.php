...
class Migration_create_test_treatments extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table("test_treatments", TRUE, $attributes);
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table("test_treatments", TRUE);
    }
