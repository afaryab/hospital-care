...
class Migration_create_reception_counters_closings extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->add_field(array(
            ...
            'closing_amount_cash' => array(
                'type' => 'INT',
                'constraint' => '11',
                'default' => '0',
                'null' => FALSE,
            ),
            'closing_amount_card' => array(
                'type' => 'INT',
                'constraint' => '11',
                'default' => '0',
                'null' => FALSE,
            ),
            'closing_amount_atm' => array(
                'type' => 'INT',
                'constraint' => '11',
                'default' => '0',
                'null' => FALSE,
        ...
        $this->dbforge->create_table("reception_counters_closings", TRUE, $attributes);
