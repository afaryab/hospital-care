                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                <span class="caption-subject bold uppercase"> Edit Panel Company</span>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-md-line-input has-success">
                                                <div class="input-icon">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Panel Company Name" name="name" value="<?= $panels['name'] ?>" required>
                                                
                                                    <label for="form_control_1">Panel Company Name</label>
                                                    <span class="help-block">Enter Panel Company Name Here!.</span>
