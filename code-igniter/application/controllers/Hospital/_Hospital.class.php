    ...
    function getNavigation(){
        return [
            'navigations' => [
                'Reception|REC' => [
                    ...
                    [
                        'label' => 'Payments',
                        'perm' => 'all',
                        'module' => 'Hospital Payments Counter',
                        'icon' => 'fas fa-cart-plus',
                        'path' => '#',
                        'order' => 1,
                        'user_config' => 'is_receptionist',
            ...
            'urlsToRemember' => [
                ...
                'HOSPITAL_EMERGENCY_COUNTER' => $this->_hospital_emergency_counter,
                'HOSPITAL_OPD_COUNTER' => $this->_hospital_opd_counter,
                'HOSPITAL_NEW_INPT_COUNTER' => $this->_hospital_new_inpt_counter,
                'HOSPITAL_DENTAL_COUNTER' => $this->_hospital_dental_counter,
                'HOSPITAL_LAB_COUNTER' => $this->_hospital_lab_counter,
                'HOSPITAL_XRAY_COUNTER' => $this->_hospital_xray_counter,
                'HOSPITAL_ULTRASOUND_COUNTER' => $this->_hospital_ultrasound_counter
            ]
            ];
    }
