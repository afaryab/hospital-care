                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> OPD Counter PS: (<?= $opd_ps_number ?>) Patient Name: (<?= $patient['pateint_name'] ?>)</span>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="m-t-4 m-b-4">
                                        <div class="input-group">
                                            ...
                                            <input id="patient_number" value="<?= $opd_ps_number ?>" name="patient_number" class="form-control" placeholder="Patient Number e.g: 2025/10/{SER}/{SR-NO}" type="text">
                                    ...
                                    <div class="m-t-4 m-b-4">
                                        <div class="form-control-group">
                                            <select class="selected_services" id="selected_services" style="width:100%" name="selected_services[]" multiple="true" required>
                                                <?php if($logged_in_user=="drnadeemcounter@hamzahospital.com"){ ?>
                                                    <optgroup label="OPD">
                                                        <?php foreach($opd_services as $service) { ?>
                                                            <?php if($service['name'] == "Consultation" || $service['name'] == "Cotaryl") { ?>
    ...
    function makeServiceProviderSelection(type, index, doctorSelectable){
        ...
        if(doctorSelectable == 1)
        {
            ...
            if(type == "OPD"){
                ...
                <?php if($logged_in_user=="drnadeemcounter@hamzahospital.com"){
                    foreach($opd_doctors as $doctor){ ?>
                    <?php if($doctor->name == "Dr. Nadeem Sheikh"){ ?>
