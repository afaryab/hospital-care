                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Emergency Counter PS: (<?= $emergency_ps_number ?>) Patient Name: (<?= $patient['pateint_name'] ?>)</span>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="m-t-4 m-b-4">
                                        <div class="input-group">
                                            ...
                                            <input id="patient_number" value="<?= $emergency_ps_number ?>" name="patient_number" class="form-control" placeholder="Patient Number e.g: 2025/10/{SER}/{SR-NO}" type="text">
                                            <input id="patient_id" value="<?= $patient_id ?>" name="patient_id" class="form-control" placeholder="" type="hidden">
                                        </div>
                                    </div>
                                    <div class="m-t-4 m-b-4">
                                            ...
                                            <select class="selected_services" id="selected_services" style="width:100%" name="selected_services[]" multiple="true" required>
                                                <optgroup label="Emergency">
                                                    <?php foreach($emergency_services as $service) { ?>
                                                        <option data_obj='<?= json_encode($service) ?>' value="EMER-<?= $service['id'] ?>"><?= $service['name'] ?></option>
                                                    <?php } ?>
                                                </optgroup>
                                                <optgroup label="OPD">
                                                    <?php foreach($opd_services as $service) { ?>
                                                        <?php if($service['is_deleted'] != 1 && $service['id'] != 12) { ?>
                                                            <option data_obj='<?= json_encode($service) ?>' value="OPD-<?= $service['id'] ?>"><?= $service['name'] ?></option>
                                                        <?php } ?>
                                                    <?php } ?>
                                                </optgroup>
                                                <optgroup label="XRay">
                                                    <?php foreach($xray_services as $service) { ?>
                                                        <option data_obj='<?= json_encode($service) ?>' value="RADP-<?= $service['id'] ?>"><?= $service['name'] ?></option>
                                                    <?php } ?>
                                                </optgroup>
                                                <optgroup label="Inpatient">
                                                    <?php foreach($inpatient_services as $service) { ?>
                                                        <option data_obj='<?= json_encode($service) ?>' value="INPT-<?= $service['id'] ?>"><?= $service['name'] ?></option>
                                                    <?php } ?>
                                                </optgroup>
                                                <optgroup label="Pathology">
                                                    <?php foreach($test_services as $service) { ?>
                                                        <option data_obj='<?= json_encode($service) ?>' value="PATH-<?= $service['id'] ?>"><?= $service['shrt_code']. $service['name'] ?></option>
                                                    <?php } ?>
                                                </optgroup>
                                                <optgroup label="DENTAL">
                                                    <?php foreach($dental_services as $service) { ?>
                                                        <option data_obj='<?= json_encode($service) ?>' value="DENTAL-<?= $service['id'] ?>"><?= $service['name'] ?></option>
                                                    <?php } ?>
                                                </optgroup>
                                                <optgroup label="ULTRA">
                                                    <?php foreach($ultrasound_services as $service) { ?>
                                                        <option data_obj='<?= json_encode($service) ?>' value="ULTRA-<?= $service['id'] ?>"><?= $service['name'] ?></option>
                                                    <?php } ?>
                                                </optgroup>
                                            </select>
                                        </div>
