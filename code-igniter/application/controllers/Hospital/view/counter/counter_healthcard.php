                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Health Card Counter</span>
                        </div>
                    </div>
                    <div id="treatments-table-div" class="portlet-body form">
                        <form method="POST">
                            <div class="row">
                                <div class="col-md-6 m-t-4 m-b-4">
                                    ...
                                    <div class="col-md-6" style="display:none">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fas fa-fingerprint"></i></span>
                                            <input id="antenatal_status" name="antenatal_status" class="form-control" placeholder="Antenatal Number" type="text">
                                        </div>
                                        <p class="help-block">Please provide patient antenatal number</p>
                                    </div>
                            ...
                            <div class="row">
                                <div id="treatmenterror" class="col-md-12" style="display:none;background-color: red;">
                                <h3 style="color:white;text-align:center;">Patient cannot be treated</h3>  
                                <!-- <h3 style="color:white;text-align:center;"><i class="fa fa-ban"></i>Patient cannot be treated</h3> -->
                                </div>
                            </div>
                            <!-- <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="form-actions noborder text-right">
                                <?php if(!empty($closingArray)){ ?>
                                    <button id="perfomButton" type="submit" class="btn btn-success">Pay</button>
                                <?php }else{ ?>
                                    <button id="dangerButton" type="button" class="btn btn-danger">You cannot perform any transaction</button>
                                <?php } ?>
                            </div>
                    </form>
                </div>
...
<script type="application/javascript">
    ...
    var PatientAntenatalElement = $('#antenatal_status');
    var stopTransaction = $('#dangerButton');
    ...
    function selectPatient (patient_id,patient_cnic, patient_name, patient_contact,antenatal_status){
        ...
        PatientAntenatalElement.val(antenatal_status);

        if(antenatal_status == 4)
        {
    ...
    jQuery(document).ready(function() {
        ...
        // PatientAntenatalElement.on('keyup change', function () {
        //     var i = 5;
        //     if ( table.column(i).search() !== this.value ) {
        //         table
        //             .column(i)
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "pageLength": 3,
            "ajax": "<?= site_url($HOSPITAL_HEALTH_CARD_PATIENTS_JSON_URL) ?>",
