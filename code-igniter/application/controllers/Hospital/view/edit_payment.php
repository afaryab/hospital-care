                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase">Edit Payment</span>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                <input type="number" class="form-control" name="refund_amount" required id="price-in-numbers" onchange="calculateBill()">
                                                <label for="form_control_1"> Enter New Amount</label>
                                                <span class="help-block"> New Amount</span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input has-success">
                                            <div class="input-icon">
                                                ...
                                                <label for="form_control_1">Amount in words</label>
                                                <span class="help-block"> Amount in words.</span>
                                                <i class="fa fa-bell-o"></i>
                                            </div>
                                        </div>
                                    </div>
