                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> Dental Appointment</span>
                        </div>
                    </div>
                    <div id="treatments-table-div" class="portlet-body form">
                        <form method="POST">
                                ...
                                <div class="col-md-6 m-t-4 m-b-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-control-group">
                                            <select class="selected_services form-control" id="selected_services" name="selected_services[]" required disabled>
                                                <option value=""></option>
                                        ...
                                        <p class="help-block">Please select services</p>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-md-line-input has-success">
                                        <div class="input-icon">
                                            ...
                                            <label for="form_control_1">Doctor</label>
                                            <span class="help-block">Select Doctor.</span>
                                        </div>
                                    </div>
                                </div>
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <input type="text" class="form-control form_meridian_datetime" placeholder="Appointment Date" name="date_time" required>
                                        <label for="form_control_1">Date & Time</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <textarea class="form-control" placeholder="Appointment Note" name="appointment_notes" ></textarea>
                                        <label for="form_control_1">Appointment Note</label>
                                        <span class="help-block">Please enter any important information you want to record.</span>
                                        <i class="fa fa-bell-o"></i>
                                    </div>
                                </div>
                            </div>
...
<link rel="stylesheet" type="text/css" href="<?= base_url('public/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') ?>"/>
<script type="text/javascript" src="<?= base_url('public/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') ?>"></script>
<style>
    .dz-details{
...
<script type="application/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        var table = $('#example').DataTable( {
            ...
            "serverSide": true,
            "pageLength": 3,
            "ajax": "<?= site_url($HOSPITAL_DENTAL_APPOINTMENT_FILE_SEARCH) ?>",
