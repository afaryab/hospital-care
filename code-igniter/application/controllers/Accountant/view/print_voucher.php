                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 invoice-payment">
                        ...
                        <table class="table">
                            ...
                            <?php if( $transaction['payed_to_employee'] == 1){?>
                                <tr>
                            ...
                            <?php }else{?>
                                <td><strong>Payed to: </strong></td>
                                <td><?= $transaction['payed_to_others'] ?></td>
                            <?php }?>
                            <?php if( $transaction['inpatient_file_id'] != 0){?>
                                <td><strong>Mr No.: </strong></td>
                                <td><?= $transaction['inpatient_file_id'] ?></td>
                            <?php }?>
                            ...
                            <?php if(!empty($payments)){ ?>
                                ...
                                <?php foreach ($payments as $payment){ ?>
                                    <tr>
                                        ...
                                        <td><?= $payment['amount_received_words'] ?></td>
                                    </tr>
                                <?php } ?>
                            <?php }else{ ?>
                                <tr>
