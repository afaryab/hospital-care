                        ...
                        <div class="col-md-12">
                            <div class="form-group form-md-line-input ">
                                <div class="input-icon">
                                    <select class="form-control" name="p_company" id="p_company" required>
                                        <option value="all">All Companies</option>
                                            <?php foreach ($panels as $panel) { ?>
                                                
                                                    <option <?= (array_key_exists('p_company',$_GET) && $_GET['p_company'] == $panel['name']) ? 'selected' : '' ?> value="<?= $panel['name'] ?>"><?= $panel['name'] ?></option>
                                                    
                                            <?php } ?>    
                                    </select>
                                    <label for="form_control_1">Select Company</label>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="font-red-sunglo">
                                    ...
                                    <?php if(isset($selectedCompany['name'])){ ?>
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-user fa-2x m-r-2"></i> <?= $selectedCompany['name'] ?></h3>
                                    <?php } ?>
                                                    ...
                                                    $bill_submitted=0;
                                                        ...
                                                        foreach($panel_payments as $pp){ 
                                                            if ($file['id'] == $pp['mr_no']){
                                                                ...
                                                                if($pp['is_bill_submitted']==1){
                                                                    $bill_submitted=$pp['amount_submitted'];
                                                                }
                                                            }
                                                        }?>
                                                        <td><?= $bill_submitted; ?></td>
                                                        <td><?= $blance ?></td>
                                                        <td><?= $bill_recieved ?></td>
                                                        <td>
