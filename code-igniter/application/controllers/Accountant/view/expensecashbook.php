...
<div class="page-content-wrapper">
    <div class="page-content">
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-md-line-input ">
                                <div class="input-icon">
                                    <select class="form-control" name="catg" id="catg" required>
                                        <option value=""></option>
                                            <?php foreach ($expcategories as $expcategorie) { ?>
                                                
                                                    <option <?= (array_key_exists('catg',$_GET) && $_GET['catg'] == $expcategorie['id']) ? 'selected' : '' ?> value="<?= $expcategorie['id'] ?>"><?= str_pad($expcategorie['id'], 3, "0", STR_PAD_LEFT); ?> - <?= $expcategorie['name'] ?></option>
                                                    
                                            <?php } ?>    
                                    </select>
                                    <label for="form_control_1">Select Category</label>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="font-red-sunglo">
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-chess fa-2x m-r-2"></i> EXPENSE STATEMENT </h3>
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-user fa-2x m-r-2"></i> <?= $selectedCategory['name'] ?></h3>
                                        ...
                                        <div class="col-lg-12">
                                            <table id="example" class="table table-bordered table-responsive table-stipped" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    if($counter == 0){ ?>
                                                        <tr class="bg-danger">
                                                            <td colspan="4">No Expense during this time.</td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                                    ...
                                                    <tr class="bg-warning lighter">
                                                        <td style="text-align: center;" colspan="4"><strong>Expense </strong></td>
                                                    </tr>
                                                    <tr>
        ...
        <?php
            ...
            }elseif(!empty($selectedCategory['name'])){ ?>
                <div class="row">
                    <div class="col-lg-12">
                        <table id="example" class="table table-bordered table-responsive table-stipped" cellspacing="0" width="100%">
                        <tr class="bg-danger">
