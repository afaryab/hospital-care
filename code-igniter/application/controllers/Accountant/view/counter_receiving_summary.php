                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="font-red-sunglo">
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-pawn fa-2x m-r-2"></i>  Counter Receiving Summary </h3>
                                                ...
                                                <tbody>
                                                    ...
                                                    if(!empty($receptionactivity)) {
                                                        foreach ($receptionactivity as $row) {
                                                            if($row['status']=="CLOSED" && $row['is_cash_recieved']==1){
                                                                $counter++;
                                                            ?>
