                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="font-red-sunglo">
                                    <h3 class="caption-subject bold uppercase"><i class="fas fa-pawn fa-2x m-r-2"></i>  Receptions Activities </h3>
                                        ...
                                        <div class="col-lg-12">
                                            <table id="example" class="table table-bordered table-responsive table-stipped" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $counter = 0;
                                                    if(!empty($receptionactivity)) {
                                                        foreach ($receptionactivity as $row) {
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a class="btn btn-primary"  href="<?= site_url($REC_TRANS.$row['id']) ?>">Summary</a></td>
                                                    ...
                                                    if($counter == 0){ ?>
                                                        <tr class="bg-danger">
                                                            <td colspan="4">No activity during this time.</td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                                </tbody>
