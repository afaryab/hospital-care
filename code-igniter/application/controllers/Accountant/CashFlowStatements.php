...
class CashFlowStatements extends MY_Controller
{
    ...
    public function index(){
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Cash FLow Statement';
            $this->_pageData['module'] = 'Cash FLow Statement';
            ...
            $html = $this->load->makeViewWithOutTemplate('cashflowstatement', $this->_pageData, true);
            $this->makeView($html);
        }else{
