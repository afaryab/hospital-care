...
class AddCounterRecievings extends MY_Controller
{
    ...
    public function index($id = 0){
        ...
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Add Counter Recievings';
            $this->_pageData['module'] = 'Add Counter Recievings';
            ...
            $html = $this->load->makeViewWithOutTemplate('add_counter_recieving', $this->_pageData, true);
            $this->makeView($html);
