...
class ReceptionActivity extends MY_Controller
{
    ...
    public function index(){
        if($this->isLoggedIn()) {
            ...
            $this->_pageData['title'] = 'Reception Activity';
            $this->_pageData['module'] = 'Reception Activity';
            ...
            $html = $this->load->makeViewWithOutTemplate('reception_activity', $this->_pageData, true);
            $this->makeView($html);
        }else{
